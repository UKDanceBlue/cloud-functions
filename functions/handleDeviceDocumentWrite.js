...
export default functions.firestore.document("devices/{deviceId}").onWrite((change, context) => {
  // Get firestore
  ...
  if (
    ...
    if (updatedDocument.latestUserId) {
      // Get the user's document form /users/{oldDocument.latestUserId}
